...
const render = exports.render = (colors, options) => {
  ...
  return deepFlatten(colorSets.map(colorSet => sizes.map(size => {
    ...
    const colorList = [colorSet.colors.accent0, colorSet.colors.accent1, colorSet.colors.accent2, colorSet.colors.accent3, colorSet.colors.accent4, colorSet.colors.accent5, colorSet.colors.accent6, colorSet.colors.accent7];
